...
//                if(customer == null) throw new Exception("customer inexistant");
                ...
                if(status == null) throw new Exception("Status invalid à la ligne "+csvRecord.getRecordNumber()+" dans le fichier '"+fileName+"'");
                else{
...
//                                }
                        ...
                        throw new Exception("Type invalid à la ligne "+csvRecord.getRecordNumber()+" dans le fichier '"+fileName+"'");
                    }
                }
